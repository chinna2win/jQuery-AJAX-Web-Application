...
<title>Number of Occurance By Day</title>
...
document.getElementById("report-viewer-frame").src="/birt/preview?__report=NumOfOccByDay.rptdesign&IncidentDate="+inc_date;
}
</script>
...
function callJavaFX(){
	var inc_date = document.getElementById("inc_date").value;
	pdfUrl = "http://10.9.82.97:8080/birt/preview?__report=NumOfOccByDay.rptdesign&__format=pdf&IncidentDate="+ inc_date;
}
</script>
	...
	<div id="report-param">
		<div class="container" id="report-param-container">
			<form action="/birt/frameset"
				...
				<h2>NUMBER OF OCCURRENCE BY DAY</h2>
