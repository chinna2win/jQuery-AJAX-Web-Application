...
<title>Individual Productivity for IOC Analyst</title>
...
<script language="javascript">
	function generate_report() {		
		...
		document.getElementById("report-viewer-frame").src = "/birt/preview?__report=IndividualProductivity.rptdesign&fromDate="
...
function callJavaFX(){
	 var from_date = document.getElementById("from_date").value;	
	 var to_date = document.getElementById("to_date").value;
	pdfUrl = "http://10.9.82.97:8080/birt/preview?__report=IndividualProductivity.rptdesign&__format=pdf&fromDate="+ from_date+"&toDate=" +to_date;  
}
</script>
	...
	<div id="report-param">
		<div class="container" id="report-param-container">
			<form action="/birt/frameset" target="report-viewer-frame"
				...
				<h3>INDIVIDUAL PRODUCTIVITY FOR IOC ANALYST</h3>
