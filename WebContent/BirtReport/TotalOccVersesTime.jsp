...
<title>Total Occurrence Verses Time</title>
...
<script language="javascript">
	function generate_report() {
		var get_date = document.getElementById("inc_date").value;
		document.getElementById("report-viewer-frame").src = "/birt/preview?__report=TotalOccVersesTime.rptdesign&getDate="
				+ get_date;
	}
</script>
...
function callJavaFX(){
	...
	pdfUrl = "http://10.9.82.97:8080/birt/preview?__report=TotalOccVersesTime.rptdesign&__format=pdf&getDate="+ inc_date;
}
</script>
	...
	<div id="report-param">
		<div class="container" id="report-param-container">
			<form action="/birt/frameset"
				...
				<h2>TOTAL OCCURRENCE VERSES TIME</h2>
				<div class="controls input-append date form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                    <input size="16" value="Select Incident Date" type="text" name="inc_date" id="inc_date" readonly>					
