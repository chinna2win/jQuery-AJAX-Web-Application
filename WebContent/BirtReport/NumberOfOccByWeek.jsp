...
<title>Number of Occurrence By Week</title>
...
<script language="javascript">
	function generate_report() {
		...
		document.getElementById("report-viewer-frame").src = "/birt/preview?__report=NumOfOccByWeek.rptdesign&fromDate="
...
function callJavaFX(){
	var from_date = document.getElementById("from_date").value;
	var to_date = document.getElementById("to_date").value;
	pdfUrl = "http://10.9.82.97:8080/birt/preview?__report=NumOfOccByWeek.rptdesign&__format=pdf&fromDate="+ from_date +"&toDate=" +to_date;
}
</script>
	...
	<div id="report-param">
		<div class="container" id="report-param-container">
			<form action="/birt/frameset"
				...
				<h2>NUMBER OF OCCURRENCE BY WEEK</h2>
				<div class="controls input-append date form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                    <input size="16" value="From Date" type="text" name="date" id="from_date" readonly>					
                    <span class="add-on"><i class="icon-remove"></i></span>
					<span class="add-on"><i class="icon-th"></i></span>
                </div>
				<div class="controls input-append date form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                    <input size="16" value="To Date" type="text" name="date" id="to_date" readonly>					
                    <span class="add-on"><i class="icon-remove"></i></span>
					<span class="add-on"><i class="icon-th"></i></span>
                </div>				
							
				<input type="button" value="Generate" id="but-generate-report"	onclick="generate_report();" /> 
				<input onclick="window.location.href='/IMPReports/'" type="button"	value="Home" />			    
				<!-- <div id="somediv"></div> -->
			</form>
			<!-- /form-report-param -->
