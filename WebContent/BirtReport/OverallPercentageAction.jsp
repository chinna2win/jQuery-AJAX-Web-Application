...
<title>Overall Percentage Action</title>
...
<script language="javascript">
	function generate_report() {		
		...
		document.getElementById("report-viewer-frame").src = "/birt/preview?__report=OverallPercentage.rptdesign&fromDate="
...
function callJavaFX(){
	var from_date = document.getElementById("from_date").value;
	var to_date = document.getElementById("to_date").value;
	pdfUrl = "http://10.9.82.97:8080/birt/preview?__report=OverallPercentage.rptdesign&__format=pdf&fromDate="+ from_date+"&toDate=" +to_date;
}
</script>
